...
//
//		//MonoAppDomain* AppDomain = nullptr;
...
//
//		// Create an App Domin
//		s_Data->AppDomain = mono_domain_create_appdomain("app", nullptr);
//		mono_domain_set(s_Data->AppDomain, true);
//
//		MonoImage* assemblyImage = mono_assembly_get_image(s_Data->CoreAssembly);
//		MonoClass* monoClass = mono_class_from_name(assemblyImage, "GT", "Main");
//

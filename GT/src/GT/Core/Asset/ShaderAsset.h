...
namespace GT
{
	...
	public:
		...
		static Ref<ShaderAsset> Create(const std::filesystem::path& filepath);
		static Ref<ShaderAsset> Create(const std::string& name, const std::string& vertexSrc, const std::string& fragmentSrc);
		static Ref<ShaderAsset> CreateCompute(const std::filesystem::path& filepath);
		static Ref<ShaderAsset> CreateGeometry(const std::filesystem::path& filepath);

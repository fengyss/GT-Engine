...
namespace GT
{
	public static class InternalCalls
	{
		...
		[MethodImplAttribute(MethodImplOptions.InternalCall)]
		internal extern static BodyType Rigidbody2DComponent_GetType(ulong entityID);
		[MethodImplAttribute(MethodImplOptions.InternalCall)]
		internal extern static void Rigidbody2DComponent_SetType(ulong entityID, BodyType type);
		[MethodImplAttribute(MethodImplOptions.InternalCall)]

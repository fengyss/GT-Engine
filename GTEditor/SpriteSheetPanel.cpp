...
namespace GT {
    ...
    SpriteSheetPanel::SpriteSheetPanel() : Layer("Sprite Sheet Tool") {}

    void SpriteSheetPanel::OnAttach() {}
    ...
    void SpriteSheetPanel::OnImGuiRender()
    {
        ...
        if (m_Texture)
        {
            ...
            {
                SpriteSheetCropper::ExportToJSON(m_Regions, "assets/spritesheet.json", m_Texture->GetPath());
            }
        }
